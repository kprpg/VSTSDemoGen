...
# Use this command to access the administrative portal - BROKEN in TP3 Refresh
 Add-AzureStackAzureRmEnvironment -ArmEndpoint "https://adminportal.local.azurestack.external" -Name "AzureStackAdmin" 

 # Use this command to access the user portal
 Add-AzureStackAzureRmEnvironment -Name "AzureStackUser" -ArmEndpoint "https://portal.local.azurestack.external"
