...
#Main
#$aadCred = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList 'tenantuser@domain',(ConvertTo-SecureString -String 'password' -AsPlainText -Force)
$aadCred = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList 'serviceadmin@microsoftazurestack.onmicrosoft.com', (ConvertTo-SecureString -String '!!123abc' -AsPlainText -Force)

# Create JSON record
Get-AzureStackUsage -StartTime 4/11/2017 -EndTime 4/12/2017 -AzureStackDomain 'local.ext-hpe.selfhost.local' -AADDomain microsoftazurestack.onmicrosoft.com  -Credential $aadCred -Granularity Hourly -Debug -Force | ConvertTo-Json
